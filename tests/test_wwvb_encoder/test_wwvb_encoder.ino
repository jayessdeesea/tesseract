...
/*
 * ARDUINO IDE SETUP:
 * Copy these files into this sketch folder (tests/test_wwvb_encoder/):
 *   - wwvb_transmitter/wwvb_encoder.h
 *   - wwvb_transmitter/wwvb_encoder.cpp
 * Then open this .ino in Arduino IDE - it will see all files as tabs.
 */
...
void testYearEncoding() {
  ...
  // Year tens = 9: 80=1, 40=0, 20=0, 10=1  (actually: 8+1=9, so 80 is for tens*10... wait)
